...
var envinfo = {"qx.application":"qxthree.Application","qx.revision":"","qx.theme":"qx.theme.Modern","qx.version":"5.0.1"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"qx":{"resourceUri":"../../qooxdoo/5.0/framework/source/resource","sourceUri":"../../qooxdoo/5.0/framework/source/class","sourceViewUri":"https://github.com/qooxdoo/qooxdoo/blob/%{qxGitBranch}/framework/source/class/%{classFilePath}#L%{lineNumber}"},"qxthree":{"resourceUri":"../source/resource","sourceUri":"../source/class"}};
